...
# HMM vs MMETSP-100
# Create HMM profile
hmmOfFasta3.py $1.refseqs.aln.fasta

# Run HMM search vs MMETSP-100 (need to update to MMETSP-139)
/share/code/bifx/hmmer/runHmmsearch3.py -o $1.vs.MMETSP-100 -u $1.refseqs.aln.hmm /home/rgrous83/CAMERA/MMETP_CAMPEP_Jun23/CAM_P_0001000.pep.fa

# call campep_fix.py
/home/rgrous83/scripts/campep_fix.py $1.vs.MMETSP-100

echo "Final output: $1.MMETSP-100.hma.fasta.fn"
