...
# Last updated 12 August 2013, 2:05pm by RG  my_gene.aln.fast
...
/share/projects/diatom_est/annotation/scripts/hmmOfFasta3.py $1.aln.fasta

# Note on 3/7/16: GeoMICS data from below moved here: /share/projects/GeoMics/Metatranscriptome/reads/processed/eukaryotic-2015-03-17
