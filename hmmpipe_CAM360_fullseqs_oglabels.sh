...
cat $1.refseqs.aln.fasta $1.vs.MMETSP-360.fasta $1.vs.CEG-7.fasta > $1.allhits.raw.fasta
...
echo "Final output of hmmsearch vs F.cylindrus: $1.vs.Fracy.fasta"
cat $1.vs.Fracy.fasta >> $1.allhits.raw.fasta
...
echo "Final output of hmmsearch vs T.pseudonana: $1.vs.Thaps.fasta"
cat $1.vs.Thaps.fasta >> $1.allhits.raw.fasta
...
echo "Final output of hmmsearch vs P.tricornutum: $1.vs.Phaeo.fasta"
cat $1.vs.Phaeo.fasta >> $1.allhits.raw.fasta
...
echo "Final output of hmmsearch vs P.multiseries: $1.vs.Psemu.fasta"
cat $1.vs.Psemu.fasta >> $1.allhits.raw.fasta
...
echo "Final output of hmmsearch vs E.siliculosis: $1.vs.Esili.fasta"
cat $1.vs.Esili.fasta >> $1.allhits.raw.fasta
...
echo "Final output of hmmsearch vs E.huxleyi: $1.vs.Ehux.fasta"
cat $1.vs.Ehux.fasta >> $1.allhits.raw.fasta
...
echo "Final output of hmmsearch vs E.huxleyi: $1.vs.Psegr.fasta"
cat $1.vs.Psegr.fasta >> $1.allhits.raw.fasta
