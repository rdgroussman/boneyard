...
if FilterType == 'diatom':
	ListString = r'/share/projects/diatom_est/annotation/scripts/phylo_lists/diatom.list'
elif FilterType == 'stramenopile':
	ListString = r'/share/projects/diatom_est/annotation/scripts/phylo_lists/stramenopile.list'
else:
...
for record in SeqIO.parse(InFASTA, 'fasta'):
	IDElements = record.id.split("_") # separate the ID by underscore
	Genus = IDElements[0] # Capture the genus
	if Genus in PhyloDict:
