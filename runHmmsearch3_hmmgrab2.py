...
# This variant modified to work with hmmgrab2.py and hmmpipe_fullseqs.sh
# RG 19Aug13
...
#   disabled this option to allow different suffixes to be used(ie, -idcleaned) - RG
...
# disabled - no ohs_to_fasta needed for this pipe, less output desired - RG    
  # # run ohs_to_fasta
